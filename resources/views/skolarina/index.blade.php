...
@section('page_heading','Уплата школарине')
@section('section')
    <div class="col-lg-12">
        <div>
        ...
        <a href="{{$putanja}}/skolarina/izmena/{{$kandidat->id}}" class="btn btn-primary"><span
                    ...
                    @if(!empty($trenutneUplate))
                        @foreach($trenutneUplate as $index => $uplata)
                            <tr>
                                ...
                                <td>{{$uplata->komentar}}</td>
                                <td>
                                    <a class="btn btn-warning" href="{{$putanja}}/uplata/edit/{{$uplata->id}}">
                                        <div title="Измена">
                                            <span class="fa fa-edit"></span>
                                        </div>
                                    </a>
                                    <a class="btn btn-danger" href="{{$putanja}}/uplata/delete/{{ $kandidat->id }}/delete"
