            ...
            <div class="panel-body">
                <form role="form" method="post" action="{{ url('/zapisnik/podaci') }}">
                    ...
                    <div class="form-group pull-left" style="width: 5%;">
                        ...
                        <button type="submit" name="Submit" id="submitPredpodaci" class="btn btn-success"><span class="fa fa-check"></span></button>
                    </div>
                    <div class="form-group pull-left" style="width: 15%;">
                    <label for="submitPredpodaci">&nbsp;</label><br>
                    <a href="{{$putanja}}/zapisnik/create" class="btn btn-danger"><span class="fa fa-close"></span></a>
                    </div>
                    <br>
                </form>
                ...
                <form role="form" method="post" action="{{$putanja}}/zapisnik/storeZapisnik">
                    ...
                    <input type="hidden" id="predmet_id_forma" name="predmet_id" value="{{ empty($predmet_id) ? $predmeti->first()->id : $predmet_id }}">
                    @if(!empty($aktivniIspitniRok))
                        <input type="hidden" id="rok_id_forma" name="rok_id" value="{{ empty($rok_id) ? $aktivniIspitniRok->first()->id : $rok_id  }}">
                    @else
                        <input type="hidden" id="rok_id_forma" name="rok_id" value="{{ empty($rok_id) ? '' : $rok_id  }}">
                    @endif
                    ...
                    <div class="clearfix"></div>
                    <hr>
                    <div class="form-group pull-left" style="width: 20%; margin-right: 2%">
                        <label for="formatDatum">Датум</label>
                        <input type="text" id="formatDatum" name="formatDatum" class="form-control dateMask" value="{{ Carbon\Carbon::now()->format('d.m.Y.') }}">
                    </div>
                    <div class="form-group pull-left" style="width: 20%; margin-right: 2%">
                        <label for="vreme">Време</label>
                        <input type="text" id="vreme" name="vreme" class="form-control timeMask">
                    </div>
                    <div class="form-group pull-left" style="width: 40%; margin-right: 15%">
