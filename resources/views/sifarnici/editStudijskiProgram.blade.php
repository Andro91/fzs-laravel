        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="form-group pull-left" style="width: 48%; margin-right: 2%;">
                    ...
                    <input name="skrNazivStudijskogPrograma" type="text" class="form-control" value="{{$studijskiProgram->skrNazivStudijskogPrograma}}">
                </div>
                <div class="form-group pull-left" style="width: 48%;  margin-right: 2%">
                    <label for="tipStudija_id">Tip studijskog programa:</label>
                    <input type="hidden" id="tipStudijaHidden" name="tipStudijaHidden" value="{{$studijskiProgram->tipStudija_id}}">
