        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="form-group pull-left" style="width: 48%; margin-right: 2%;">
                    ...
                    <input name="nazivRimski" type="text" class="form-control" value="{{$godinaStudija->nazivRimski}}">
                </div>
                <div class="form-group pull-left" style="width: 48%; margin-right: 2%;">
                    <label for="naziv">Naziv u padežu:</label>
                    <input name="nazivSlovimaUPadezu" type="text" class="form-control" value="{{$godinaStudija->nazivSlovimaUPadezu}}">
                </div>
                <div class="form-group pull-left" style="width: 48%; margin-right: 2%;">
                    <label for="naziv">Redosled prikazivanja:</label>
                    <input name="redosledPrikazivanja" type="text" class="form-control" value="{{$godinaStudija->redosledPrikazivanja}}">
                </div>
                <div class="form-group pull-left" style="width: 48%; margin-right: 2%;">
