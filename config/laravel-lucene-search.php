        ...
        'models' => [
            ...
            \App\Kandidat::class => [
                'fields' => [
                    ...
                    'adresaStavanja',
                    'email',
                    'imePrezimeJedgRoditelja',
                    'kontaktTelefonRoditelja',
                    'srednjeSkoleFakulteti',
                    'mestoZavrseneSkoleFakulteta',
                    'smerZavrseneSkoleFakulteta',
                    'srednjaOcenaSrednjaSkola',
                    'telesnaTezina',
                    'visina',
                    'brojBodovaTest',
                    'brojBodovaSkola',
                    ...
                    'datumStatusa', // fields for indexing
                ]
            ]
        ],
    ],
